    ...
    private ByteArrayOutputStream pdfInternalFx(String path) {
        ...
        try {
...

            {
                ...
                cell.setPhrase(new Phrase(10, "شماره نقشه", f26));
                cell.setColspan(1);
                productDSC.addCell(cell);
                ...
                cell.setPhrase(new Phrase(10, "قيمت واحد", f26));
                cell.setColspan(1);
                productDSC.addCell(cell);

                cell.setPhrase(new Phrase(10, "قيمت مدل", f26));
                cell.setColspan(1);
                productDSC.addCell(cell);

                cell.setPhrase(new Phrase(10, "قيمت قالب", f26));
                cell.setColspan(1);
                productDSC.addCell(cell);

                cell.setPhrase(new Phrase(10, "قيمت کل", f26));
                cell.setColspan(1);
                productDSC.addCell(cell);

//			cell.setPhrase(new Phrase(10, "محل تحويل", f1));
//			cell.setColspan(1);
//			productDSC.addCell(cell);

                cell.setPhrase(new Phrase(10, "تحويل بر اساس", f26));
                cell.setColspan(1);
                productDSC.addCell(cell);
                ...
                if ( registerPriceHeader.getPortageCost() != null) {
                    cell.setPhrase(new Phrase(10,
                            "هزينه بسته بندي ، بارگيري و حمل : " + (registerPriceHeader.getSumPrice()!=null?
                ...
                cell.setPhrase(new Phrase(10, "هزينه ماليات بر ارزش افزوده : " +(registerPriceHeader.getTaxCost()!=null?registerPriceHeader.getTaxCost():""),
                        f26));
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                cell.setVerticalAlignment(Element.ALIGN_LEFT);
                cell.setColspan(15);
                ...
                cell.setPhrase(new Phrase(10, ":هزینه بسته بندی بارگیری و حمل" +(registerPriceHeader.getPortageCost()!=null?decimalFormat.format(new Double(registerPriceHeader.getPortageCost())):""),f26));
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                cell.setVerticalAlignment(Element.ALIGN_LEFT);
                cell.setColspan(10);
                productDSC.addCell(cell);
...
//aaaaa
                ...
                cell.setPhrase(new Phrase(10, "جمع کل قيمت پيشنهاد به حروف و عدد: ", f7));
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                cell.setVerticalAlignment(Element.ALIGN_CENTER);
                cell.setColspan(18);
                productDSC.addCell(cell);
...
//			// Craete table definitions
                ...
                cell.setPhrase(new Phrase(10," مشخصات فني و شرايط بازرسي پيوست مورد تاييد مي باشد. \n  لازم به ذکر است اولويت  با سازندگاني است که زمان پيشنهادي ايشان با زمان اعلام شده  براي  هرقطعه  تطابق داشته و يا نزديکتر باشد.\n لطفا فرم آناليزقيمت پيوست تکميل ، مهر و امضاء و به همراه فرم پيشنهاد قيمت ارسال گردد.", f25));
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                cell.setVerticalAlignment(Element.ALIGN_LEFT);
                cell.setColspan(6);
